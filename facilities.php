                ...
                <div class="app-main__inner">
                    <div class="tabs-animation">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <span class="mr-auto"><b>List of Facilities</b></span>
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-header">
                                <span class="mr-auto">List of health facilities in Bulacan</span>
                            </div>
                            <div class=" card-body">
                                <table style="width: 100%;" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        if (mysqli_num_rows($result_getHospitalName) > 0) {
                                            while ($row_getHospitalName = mysqli_fetch_assoc($result_getHospitalName)) {
                                                echo "
                                                        <tr>
                                                            <td>" . $row_getHospitalName["facilityid"] . "</td>
                                                            <td>" . ucwords($row_getHospitalName["name"]) . "</td>
                                                        </tr>
                                                        ";
                                            }
                                        }
