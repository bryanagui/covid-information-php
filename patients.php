...
<head>
    ...
    <script type="text/javascript" src="./d072c492963735/e83jsnc7312822.js"></script>
    ...
    <?php
    $query_getPatientsAdmitted = "SELECT * FROM fcdb_patients_admitted";
    $result_getPatientsAdmitted = mysqli_query($conn, $query_getPatientsAdmitted);

    $query_getPatientsReleased = "SELECT * FROM fcdb_patients_released";
    $result_getPatientsReleased = mysqli_query($conn, $query_getPatientsReleased);
    ?>
</head>
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <span class="mr-auto"><b>Patients</b></span>
                                ...
                                <div class="card mb-3 widget-chart">
                                    <div class="widget-chart-content">
                                        <div class="widget-numbers">
                                            <span id="occupied-beds" data-occ="0">0</span>
                                        </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class="card mb-3 widget-chart">
                                    <div class="widget-chart-content">
                                        <div class="widget-numbers">
                                            <span id="vacant-beds" data-vac="0">0</span>
                                        </div>
                                        <div class="widget-subheading fsize-1 pt-2 opacity-10 font-weight-bold">
                                            Vacant
                                        </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class="card mb-3 widget-chart">
                                    <div class="widget-chart-content">
                                        <div class="widget-numbers">
                                            <span id="total-beds" data-tot="0">0</span>
                                        </div>
                                        <div class="widget-subheading fsize-1 pt-2 opacity-10 font-weight-bold">
                                            Total
                                        </div>
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                    <strong>Important Note: </strong>Only the last 50 released patients within 30 days are listed below.
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-header">
                                        <span class="mr-auto">List of Currently Admitted Patients</span>
                                    </div>
                                    <div class="card-body">
                                        <table style="width: 100%;" class="table table-hover table-striped table-bordered" id="admissions">
                                            <thead>
                                                <tr>
                                                    <th>Full Name</th>
                                                    <th>Age</th>
                                            ...
                                            <tbody id="table-body">
                                                <?php
                                                while ($row_getPatientsAdmitted = mysqli_fetch_assoc($result_getPatientsAdmitted)) {
                                                    echo '
                                                            <tr>
                                                                <td>' . $row_getPatientsAdmitted["fullname"] . '</td>
                                                                <td>' . $row_getPatientsAdmitted["age"] . '</td>
                                                                <td>' . $row_getPatientsAdmitted["address"] . '</td>
                                                                <td>' . date("m-d-Y", strtotime($row_getPatientsAdmitted["admission_date"])) . '</td>
                                                                <td>' . date('m-d-Y', strtotime($row_getPatientsAdmitted["admission_date"] . ' + 14 days')) . '</td>
                                                            </tr>
                                                            ';
                                                }
                                                ?>
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">
                                        <span class="mr-auto">List of Released Patients</span>
                                    </div>
                                    <div class="card-body">
                                        <table style="width: 100%;" class="table table-hover table-striped table-bordered" id="releases">
                                            <thead>
                                                <tr>
                                                    <th>Full Name</th>
                                                    <th>Age</th>
                                            ...
                                            <tbody id="table-body">
                                                <?php
                                                while ($row_getPatientsReleased = mysqli_fetch_assoc($result_getPatientsReleased)) {
                                                    echo '
                                                            <tr>
                                                                <td>' . $row_getPatientsReleased["fullname"] . '</td>
                                                                <td>' . $row_getPatientsReleased["age"] . '</td>
                                                                <td>' . $row_getPatientsReleased["address"] . '</td>
                                                                <td>' . date("m-d-Y", strtotime($row_getPatientsReleased["date_released"])) . '</td>
                                                            </tr>
                                                            ';
                                                }
                                                ?>
        ...
        <span id="facility-name" hidden><?php echo $hospitalname; ?></span>
    </div>
